...
const TEAM_MEMBERS = [
  {
    ...
    role: "Founder & CEO",
    src: "/team/temi.png",
    bio: "Temi is a pharmacologist focused on optimizing AI models for early drug discovery, and sets the strategic direction and roadmap for Attention Labs. He holds a PhD in pharmacology and spun out Attention Labs from his research at Boston Children's Hospital, Harvard Medical School. He brings prior business development experience from Pfizer and Sanofi, combining scientific depth with strategic leadership.",
  },
  {
    name: "Noah Abasciano",
