      ...
      <section className="py-20 border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Attention Bio */}
            <div className="group relative rounded-2xl p-[2px] bg-gradient-to-r from-[#9d5cff]/10 to-[#5ce5e5]/10 hover:from-[#9d5cff] hover:to-[#5ce5e5] transition-all duration-300">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative rounded-2xl p-[2px] bg-gradient-to-r from-[#9d5cff]/10 to-[#5ce5e5]/10 hover:from-[#9d5cff] hover:to-[#5ce5e5] transition-all duration-300 block"
              >
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={a.name}
                className="group relative rounded-2xl p-[2px] bg-gradient-to-r from-[#9d5cff]/10 to-[#5ce5e5]/10 hover:from-[#9d5cff] hover:to-[#5ce5e5] transition-all duration-300"
              >
